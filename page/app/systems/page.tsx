...
export default function SystemsPage() {
    ...
    return (
        <div className="relative overflow-hidden h-[calc(100vh-60px)]">
            <div className="pt-10 px-5 flex flex-col h-full relative z-10">
            ...
            <Image src="/Drawing.png" alt="Background Drawing" className="absolute md:block hidden right-0 bottom-0 w-auto min-w-max pointer-events-none" style={{height: '700px', zIndex: 0}} width={4000} height={4000} />
        </div>
    );
}